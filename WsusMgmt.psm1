...
function Start-WsusIniialization {
    [CmdletBinding()]
    param (
...
Export-ModuleMember -Function Start-WsusIniialization,Sync-WsusApprovedUpdates,Sync-WsusCategories,Sync-WsusDeclinedUpdates,Sync-WsusTargetGroup
